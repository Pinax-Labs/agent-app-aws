        ...
        if agent_name == "sage":
            if st.button("Tell me about Pinaxai"):
                await add_message(
                    agent_name,
                    "user",
                    "Tell me about Pinaxai. Github repo: https://github.com/Pinax-Labs/pinaxai. Documentation: https://docs.pinax.tech",
                )
...
async def about_pinaxai():
    ...
    with st.sidebar:
        ...
        st.markdown("""
        Pinaxai is an open-source library for building Multimodal Agents.
...
async def footer():
    st.markdown("---")
    st.markdown(
        "<p style='text-align: right; color: gray;'>Built using <a href='https://github.com/Pinax-Labs/pinaxai'>Pinaxai</a></p>",
