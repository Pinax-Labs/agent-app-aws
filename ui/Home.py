...
from pinaxai.tools.streamlit.components import check_password

from ui.css import CUSTOM_CSS
from ui.utils import about_pinaxai, footer

nest_asyncio.apply()

st.set_page_config(
    page_title="Pinaxai Agents",
...
async def header():
    st.markdown("<h1 class='heading'>Pinaxai Agents</h1>", unsafe_allow_html=True)
    st.markdown(
        "<p class='subheading'>Welcome to the Pinaxai Agents platform! We've provided some sample agents to get you started.</p>",
